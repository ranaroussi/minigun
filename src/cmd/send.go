...
func init() {
	...
	sendBulkCmd.Flags().IntVar(&sendBatchSize, "batch-size", 200, "Batch size")
	sendBulkCmd.Flags().IntVar(&sendThrottleMS, "throttle-ms", 500, "Throttle between batches in ms")
